...
echo '<script language="javascript">alert("Email này đã có người dùng. Vui lòng nhập Email khác."); window.location="register.php";</script>';
exit;
}
}
}
