	...
	<nav class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="width: auto;">
		...
		<table class="w3-table-all w3-hoverable">
							<tr>
                  			...
                  			<tr >
                  				<td>Mã phiếu nhập: </td>
                  				<td><input type="text" size="30" value="<?php echo $value['import_id'] ?>" name="maph"></td>
                  			</tr>
                  			<tr >
                  				<td>Mã hàng: </td>
                  				<td><input type="text" size="30" value="<?php echo $value['good_id'] ?>" name="mah"></td>
                  			</tr>
                  			<tr >
                  				<td>Tên hàng: </td>
                  				<td><input type="text" size="30" value="<?php echo $value['goods_name'] ?>" name="tenh"></td>
                  			</tr>
